    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#34ABAB" },
                textPrimary: mode === "light" ? "#34ABAB" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#34ABAB" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#34ABAB" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #34ABAB, #49C7C7, #6BD1D1)" : "#666",

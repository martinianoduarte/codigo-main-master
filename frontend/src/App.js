    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#1CBDFB" },
                textPrimary: mode === "light" ? "#1CBDFB" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#1CBDFB" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#1CBDFB" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #8DEAFE, #1CBDFB, #019DBE)" : "#666",
